                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{url('/save/userinfo')}}">
                                           <!--  {{ Form::open(array('url' => '/save/userinfo', 'method' => 'post')) }} -->
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="inputFirstName">First Name</label><input class="form-control py-4" id="inputFirstName" name="fname" type="text" placeholder="Enter first name" /></div>
                                                    @error('fname')
                                                    {{$message}}
                                                    @enderror
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group"><label class="small mb-1" for="inputConfirmPassword">Confirm Password</label><input class="form-control py-4" id="inputConfirmPassword" name="confirm_password" type="password" placeholder="Confirm password" /></div>
                                                </div>
                                            </div>
